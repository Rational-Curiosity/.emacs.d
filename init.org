  ...
  (with-eval-after-load 'exwm-input
    ...
    (setq exwm-input-global-keys
          `(;; Universal argument
            ...
            ;; C-SPC trick
            (,(kbd "C-SPC") . exwm-ctrl-space)
            (,(kbd "C-S-SPC") . exwm-ctrl-space))))

  (with-eval-after-load 'exwm-manage
    (setq exwm-manage-configurations
          '(((member exwm-class-name
                     '("Emacs" "st-256color" "Alacritty" "URxvt" "XTerm" "nyxt"))
             char-mode t
...
;;]* [#$] "
  ...
  ;; Post prompt ;;
  ;; ;;;;;;;;;;; ;;
  (defvar eshell-play-sound-time-threshold 30)
...
(with-eval-after-load 'org-super-agenda
  ...
  (setq org-super-agenda-fontify-whole-header-line t
        ...
        '((:name "Hoy"
          ...
          (:name "Hábito"
                 :habit t)))
  (named-code-eval 'org-super-agenda-config))
#+end_src
...
(named-code-eval 'machine-config)
#+end_src
