...
#+begin_src sh
./configure --with-json --with-cairo --with-x-toolkit=gtk3 --without-toolkit-scroll-bars --without-gconf --without-xaw3d --without-gsettings --with-xwidgets CFLAGS='-O3 -mtune=native -march=native'
#+end_src
...
(with-eval-after-load 'exwm
  ...
  ;; ace-window
  (define-key exwm-mode-map (kbd "M-o") 'exwm-ace-window)
  ;; C-SPC trick
