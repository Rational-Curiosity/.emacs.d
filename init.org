...
(defun bound-eval-and-unbound (func &rest args)
  "Ensures FUNC exist and eval with ARGS."
  (if (fboundp func)
      (progn
        (apply func args)
        (fmakunbound func))
    (message "Missing `%s' function" func)))
...
(with-eval-after-load 'ede
  ...
  (bound-eval-and-unbound 'after-ede-config))
#+end_src
...
Throw an error when trying to set a property with an invalid name."
  ...
  (bound-eval-and-unbound 'after-org-config))
#+end_src
...
(with-eval-after-load 'org-super-agenda
  ...
  (setq org-super-agenda-fontify-whole-header-line t
        ...
        '((:name "Hoy"
          ...
          (:name "Hábito"
                 :habit t)))
  (bound-eval-and-unbound 'after-org-super-agenda-config))
#+end_src
...
(bound-eval-and-unbound 'after-machine-config)
#+end_src
