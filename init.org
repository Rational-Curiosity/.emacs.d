...
;;;;;;;;;;;;;;;
  ...
  (defun transparent-frame (arg)
    (interactive "P")
    (unless arg
      (setq arg 0))
    (set-frame-parameter nil 'alpha `(,arg . ,arg)))
...
(global-set-key (kbd "M-g f") 'consult-fdfind)
...
(global-set-key (kbd "M-g M-g") 'consult-kmacro)
