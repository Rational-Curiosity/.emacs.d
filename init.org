...
(if (boundp 'after-focus-change-function)
    (add-function :after after-focus-change-function
                  'force-mode-line-buffer-identification)
  (add-hook 'focus-in-hook 'force-mode-line-buffer-identification)
  (add-hook 'focus-out-hook 'force-mode-line-buffer-identification))
...
(with-eval-after-load 'ede
  ...
  (bound-and-eval 'after-ede-config))
#+end_src
...
Throw an error when trying to set a property with an invalid name."
  ...
  (bound-and-eval 'after-org-config))
#+end_src
...
(with-eval-after-load 'org-super-agenda
  ...
  (setq org-super-agenda-fontify-whole-header-line t
        ...
        '((:name "Hoy"
          ...
          (:name "Hábito"
                 :habit t)))
  (bound-and-eval 'after-org-super-agenda-config))
#+end_src
...
(bound-and-eval 'after-machine-config)
#+end_src
