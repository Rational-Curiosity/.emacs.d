...
#+begin_src sh
./configure --with-json --with-cairo --with-x-toolkit=no --without-toolkit-scroll-bars --without-gconf --without-xaw3d --without-gsettings CFLAGS='-O3 -mtune=native -march=native'
#+end_src
