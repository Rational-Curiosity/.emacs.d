...
(with-eval-after-load 'hideshow
  ...
  (defface hideshow-overlay-face
    '((t (:foreground "purple" :box '(:line-width -1))))
...
(with-eval-after-load 'compile
  ...
  (push '("\\_<\\([A-Za-z]*[Ee]rrors?\\|ERRORS?\\|[A-Za-z]*[Ee]xceptions?\\|EXCEPTIONS?\\|\\(std\\)?[Ee]rr\\(no\\)?\\|\\(STD\\)?ERR\\(NO\\)?\\|[Ff]ailed\\|FAILED\\|[Ff]ailures?\\|FAILURES?\\|[Ff]ails?\\|FAILS?\\)\\_>"
...
(with-eval-after-load 'org
  ...
  (set-face-attribute 'org-agenda-date nil :background "#262e0d" :box '(:line-width -1))
