...
#+begin_src sh
./configure --with-json --with-cairo --without-x-toolkit --without-toolkit-scroll-bars --without-gconf --without-xaw3d --without-gsettings --without-xwidgets --with-native-compilation CFLAGS='-O3 -mtune=native -march=native'
#+end_src
...
(defun bug-ediff-defun-at-point ()
  (interactive)
  (let* ((defnA (or (thing-at-point 'defun)
...
(face-spec-set 'region
               '((((class color) (min-colors 88) (supports :box t))
                  :box (:line-width (-1 . -1) :color "CadetBlue" :style nil)
                  :background "DarkSlateGray" :extend nil)
                 (((class color) (min-colors 88) (background dark))
                  :background "blue3" :extend nil)
                 (((class color) (min-colors 88) (background light) (type gtk))
                  :distant-foreground "gtk_selection_fg_color"
                  :background "gtk_selection_bg_color" :extend nil)
                 (((class color) (min-colors 88) (background light) (type ns))
                  :distant-foreground "ns_selection_fg_color"
                  :background "ns_selection_bg_color" :extend nil)
                 (((class color) (min-colors 88) (background light))
                  :background "lightgoldenrod2" :extend nil)
                 (((class color) (min-colors 16) (background dark))
                  :background "blue3" :extend nil)
                 (((class color) (min-colors 16) (background light))
                  :background "lightgoldenrod2" :extend nil)
                 (((class color) (min-colors 8))
                  :background "blue" :foreground "white" :extend nil)
                 (((type tty) (class mono))
                  :inverse-video t)
                 (t :background "gray" :extend nil)))
#+end_src
...
(with-eval-after-load 'flymake
  ...
  (define-key flymake-mode-map (kbd "M-c ! l") #'flymake-show-diagnostics-buffer)
...
(define-key completion-in-region-mode-map (kbd "C-v")
  'orderless-match-components-cycle)
#+end_src
...
(with-eval-after-load 'consult
  ...
  (setq consult-project-root-function 'project-root-directory
        consult-find-command "fdfind -H --color=never --full-path OPTS ARG"
        consult-ripgrep-command
        "rg --hidden --null --line-buffered --color=ansi --max-columns=1000 --no-heading --line-number OPTS . -e ARG"
...
(global-set-key (kbd "C-S-e") 'embark-act-noquit)
#+end_src
...
#+begin_src elisp
(require 'redmine-gitlab-api-autoloads)
#+end_src
