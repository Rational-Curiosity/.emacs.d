...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yasnippet-snippets fish-completion fish-mode lv org org-plus-contrib shut-up swiper multi-line org-super-agenda plantuml-mode projectile rich-minority rtags which-key helm-flycheck helm-flyspell helm helm-projectile helm-core org-trello helm-company helm-ag pythonic vdiff smartparens vimish-fold format-all flycheck-julia julia-mode counsel-projectile ivy counsel dumb-jump flycheck-haskell haskell-mode hy-mode goto-chg flycheck-nimsuggest commenter concurrent ctable epc nim-mode cyphejor flycheck-popup-tip company-anaconda anaconda-mode yasnippet smart-mode-line string-inflection srefactor auctex company-auctex csharp-mode hierarchy json-reformat json-snatcher xahk-mode json-navigator json-mode company-lua flymake-lua lua-mode ht cursor-chg company-emacs-eclim eclim memoize highlight-indent-guides flymake ox-gfm undo-tree vlf smartscan highlight-thing f hide-comnt avy protobuf-mode csv-mode markdown-mode+ gnuplot gnuplot-mode sphinx-doc sphinx-frontend deferred request request-deferred ox-rst stickyfunc-enhance org-agenda-property ox-twbs markdown-mode async bind-key cmake-mode company dash epl let-alist pkg-info popup s seq web-completion-data flycheck irony company-go dart-mode go-mode ob-dart ob-go free-keys company-irony-c-headers company-irony transpose-frame smooth-scrolling rebox2 rainbow-delimiters org-bullets multiple-cursors hydra htmlize graphviz-dot-mode figlet expand-region emacs-cl dash-functional company-web company-shell company-c-headers cmake-font-lock clang-format bash-completion android-mode ag))))
