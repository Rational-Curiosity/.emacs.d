...
(global-set-key (kbd "M-a") #'sp-backward-up-sexp)
(global-set-key (kbd "S-<down>") #'sp-down-sexp)
(global-set-key (kbd "C-S-<left>") #'sp-dwim-beginning-of-sexp)
(global-set-key (kbd "C-S-<right>") #'sp-dwim-end-of-sexp)
(global-set-key (kbd "M-e") #'sp-up-sexp)
(global-set-key (kbd "C-S-<down>") #'sp-down-sexp)
(global-set-key (kbd "C-S-<delete>") #'kill-to-end-of-sexp)
(global-set-key (kbd "M-s <delete>") #'kill-to-end-of-sexp)
(global-set-key (kbd "C-S-<insert>") #'kill-to-begin-of-sexp)
(global-set-key (kbd "M-s <insert>") #'kill-to-begin-of-sexp)
(global-set-key (kbd "C-S-<home>") #'sp-forward-barf-sexp)
(global-set-key (kbd "C-S-<end>") #'sp-slurp-hybrid-sexp)
(global-set-key (kbd "C-S-<prior>") #'sp-backward-slurp-sexp)
(global-set-key (kbd "C-S-<next>") #'sp-backward-barf-sexp)
(global-set-key (kbd "C-)") #'sp-unwrap-sexp-lc)
(global-set-key (kbd "C-(") #'sp-rewrap-sexp-lc)
(global-set-key (kbd "C-\"") #'sp-swap-enclosing-sexp)
(global-set-key (kbd "C-S-<return>") #'sp-split-sexp)
(global-set-key (kbd "C-c ( m") #'hydra-sp-change/body)
(global-set-key (kbd "C-c ( <") #'remove-c-<-as-paren-syntax-backward)
(global-set-key (kbd "<f7> <") #'toggle-sp-angle-pair)
