...
(define-key modal-mode-map "c ! c" #'flycheck-buffer)
(define-key modal-mode-map "c ! n" #'flycheck-next-error)
(define-key modal-mode-map "c ! p" #'flycheck-previous-error)
(define-key modal-mode-map "c ! l" #'flycheck-list-errors)
(modal-define-kbd "c b" "C-c C-b" "go-back")
(modal-define-kbd "c c" "C-c C-c")
(define-key modal-mode-map "c e w" #'er/mark-word)
(define-key modal-mode-map "c e s" #'er/mark-symbol)
(define-key modal-mode-map "c e c" #'er/mark-method-call)
(define-key modal-mode-map "c e q" #'er/mark-inside-quotes)
(define-key modal-mode-map "c e Q" #'er/mark-outside-quotes)
(define-key modal-mode-map "c e p" #'er/mark-inside-pairs)
(define-key modal-mode-map "c e P" #'er/mark-outside-pairs)
(define-key modal-mode-map "c i s" #'spanish-dictionary)
(define-key modal-mode-map "c i e" #'english-dictionary)
(define-key modal-mode-map "c i c" #'flyspell-buffer)
(define-key modal-mode-map "c i n" #'flyspell-goto-next-error)
(define-key modal-mode-map "c i p" #'flyspell-goto-previous-error)
(define-key modal-mode-map "c i a" #'flyspell-auto-correct-word)
(modal-define-kbd "c k" "C-c C-k")
(define-key modal-mode-map "c m p" #'mc/mark-previous-like-this)
(define-key modal-mode-map "c m n" #'mc/mark-next-like-this)
(define-key modal-mode-map "c m a" #'mc/mark-all-like-this-dwim)
(modal-define-kbd "c n" "C-c C-n" "smartscan-symbol-go-forward")
(define-key modal-mode-map "c o" #'operate-on-number-at-point-or-region)
